...
class Receipt(object):
    def setupUi(self, MainWindow):
        ...
        self.receipt_txt = QPushButton(self.page_home)
        self.receipt_txt.setEnabled(True)
        self.receipt_txt.setMaximumSize(QSize(16777215, 40))
        font = QFont()
        font.setFamily("ArcadeClassic")
        font.setPointSize(16)
        self.receipt_txt.setFont(font)
        self.receipt_txt.setStyleSheet("color: rgb(255, 255, 255);")
        self.receipt_txt.setObjectName("receipt_txt")
        self.verticalLayout_5.addWidget(self.receipt_txt)
        self.by_txt = QLabel(self.page_home)
        self.by_txt.setMaximumSize(QSize(16777215, 10))
        font = QFont()
        font.setFamily("ArcadeClassic")
        font.setPointSize(9)
        self.by_txt.setFont(font)
        self.by_txt.setAlignment(Qt.AlignCenter)
        self.by_txt.setObjectName("by_txt")
        self.verticalLayout_5.addWidget(self.by_txt)
        self.label = QLabel(self.page_home)
        self.label.setText("")
        self.label.setObjectName("label")
        self.verticalLayout_5.addWidget(self.label)
        self.tableWidget = QTableWidget(self.page_home)
        self.tableWidget.setMaximumSize(QSize(250, 450))
        ...
        font.setFamily("ArcadeClassic")
        item.setFont(font)
        item.setBackground(QColor(16, 30, 65))
        brush = QBrush(QColor(0, 0, 0))
        brush.setStyle(Qt.SolidPattern)
        ...
        self.verticalLayout_5.addWidget(self.tableWidget, 0, Qt.AlignHCenter)
        self.label_2 = QLabel(self.page_home)
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.verticalLayout_5.addWidget(self.label_2)
        self.btn_close = QPushButton(self.page_home)
        ...
        self.verticalLayout_5.addWidget(self.btn_close, 0, Qt.AlignHCenter)
        ...
        for key, value in data.items():
            ...
            paid = QTableWidgetItem("{0:.2f}".format(value))

            self.tableWidget.insertRow(self.items)
            self.tableWidget.setItem(self.items, 0, name)
            self.tableWidget.setItem(self.items, 1, paid)
            self.items += 1
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.home_top_info_2.setText(_translate("MainWindow", "| receipt"))
        self.receipt_txt.setText(_translate("MainWindow", "Receipt"))
        self.by_txt.setText(_translate("MainWindow", "by han ka kao"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "net paid (Baht)"))
